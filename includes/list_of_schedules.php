    ...
    $.ajax({
        ...
        success: function (response){
            $.each(response,function(index,value){
                html +='<tr class=stud_id_'+value.student_id+'>';
                html +='<td>'+ value.school_id + '</td>';
                html +='<td>'+ value.first_name +' '+ value.last_name+ '</td>';
                html +='<td><button class="btn btn-sm btn-danger" onclick="deleteAssignedStudent('+value.student_id+')"><i class="fa fa-trash"></i></button></td>';
                html +='</tr>';
            });
...
function deleteAssignedStudent(id){
    var confirmation = confirm("are you sure you want to remove this student in this subject?");

    if(confirmation){
        $.ajax({
        type: "post",
        dataType: "json",
        url: "../includes/subject_details.inc.php?deleteassignedstudent="+id, 
        success: function (response){
            listofStudents(id);
