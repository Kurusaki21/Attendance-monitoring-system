                    ...
                    <ul class="navbar-nav ml-auto " >
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" tabindex="999">
                                                ...
                                                <div class="row md-12">
                                                    ...
                                                    <div class="form-group col-md-12">
                                                      <h6 class="card-title mb-2  font-weight-bold text-gray-500">Date</h6>
                                                          <input type="date" name="today_date" class="form-control" value="<?php echo date('2024-01-05'); ?>" readonly/>
                                                    </div>
